...
rObjC2 <- function(r, tt, a, bb, lenPre, lenPost) {
    .Call('DstarM_rObjC2', PACKAGE = 'DstarM', r, tt, a, bb, lenPre, lenPost)
}

rObjC1 <- function(r, tt, a, bb, lenPre) {
    .Call('DstarM_rObjC1', PACKAGE = 'DstarM', r, tt, a, bb, lenPre)
}

rObjC0 <- function(r, tt, a, bb, lenPost) {
    .Call('DstarM_rObjC0', PACKAGE = 'DstarM', r, tt, a, bb, lenPost)
}
